...
const Cpns = () => {
  ...
  // MOBILE POSITION
  const [positionAndroid] = useState({
    x: 20,
    y: 70,
  });
  ...
  // REDUX
  const win = useSelector((state) => state.window.windows.cpns);
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p className="text-white font-semibold">Cpns.com</p>
        </div>
      </div>
      ...
      {win?.isOpen && (
        <div
          ...
          onMouseDown={() => dispatch(focusWindow("cpns"))}
        ...
        >
          ...
          >
            <div className="flex gap-2">
              <button
                onClick={() => dispatch(closeWindow("cpns"))}
          ...
          <div className="p-5 text-black">
            <div>
              <p>
                <span className="font-semibold">Name Website:</span> CPNS.com
              </p>
            ...
            <img src="/images/dekstop/cpns.JPG" alt="" className="mt-1" />
          </div>
        </div>
      )}
      ...
      <div
        style={{
          position: "absolute",
          zIndex: 1000,
          left: positionAndroid.x,
          top: positionAndroid.y,
        }}
        className="w-20"
      >
